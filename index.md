...
| Joint style transfer (Proposed)  | With this ship, we can kill bandits all over the worlds! | <audio controls><source src="./wavs/casestudy/case_change.wav" type="audio/wav">Your browser does not support the audio element.</audio> | <img src="./wavs/casestudy/zh2en_pro.png" width="80%"> |
